...
export default [
      ...
      <div className="portfolio-item">
        ...
        <div className="portfolio-item__links">
          <a
            ...
            href="http://www.chesssoc.hkusu.hku.hk/"
          >
            Link
          </a>
        </div>
  ...
  },
  {
    ...
    render: (
      <div className="portfolio-item">
        <div className="portfolio-item__title">Personal Page</div>
        <div className="portfolio-item__desc">
        ...
        <div className="portfolio-item__links">
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/kalvin807/homepage"
          >
            Github
          </a>
        </div>
  ...
  },
  {
    ...
    render: (
      <div className="portfolio-item">
        <div className="portfolio-item__title">Minecraft Server</div>
        <div className="portfolio-item__desc">
